...
namespace UserTest.Web {
    ...
    public partial class UserTestAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private UserTest.Module.UserTestModule module3;
        private UserTest.Module.Web.UserTestAspNetModule module4;
        ...
        static UserTestAspNetApplication() {
        ...
        #endregion
        public UserTestAspNetApplication() {
            InitializeComponent();
			InitializeDefaults();
            //允许登录串口查看公司、员工数据
        ...
        protected override void CreateDefaultObjectSpaceProvider(CreateCustomObjectSpaceProviderEventArgs args) {
            ...
            {
                nonPersistentTypeInfoSource = new NonPersistentTypeInfoSource(TypesInfo, new List<Type>() { typeof(CustomLogonParameters) });
            }
        ...
        private void UserTestAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
