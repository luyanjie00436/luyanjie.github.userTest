...
namespace UserTest.Web {
    public class Global : System.Web.HttpApplication {
        ...
        protected void Session_Start(Object sender, EventArgs e) {
            Tracing.Initialize();
            WebApplication.SetInstance(Session, new UserTestAspNetApplication());               //启动登录程序
            ...
            WebApplication.Instance.CreateCustomLogonWindowObjectSpace += application_CreateCustomLogonWindowObjectSpace;
